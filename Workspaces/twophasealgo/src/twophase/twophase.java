...
//		int i=0;
				...
				if(line.contains("dashed")&& line.contains("red"))
					mat[Integer.parseInt(nodes[0])][Integer.parseInt(nodes[1])]=2;
				else if(line.contains("dashed")&& line.contains("brown"))
				{
					mat[Integer.parseInt(nodes[0])][Integer.parseInt(nodes[1])]=3;
				}
				else if(line.contains("dotted"))
				{
			...
			/*	s1=s;
				...
				*/
				//
	BufferedWriter outnew = new BufferedWriter(new FileWriter("D://graphvizslice1.gv"));
	GV=new BufferedReader(new FileReader("D:\\graphviz.gv"));
	String nno;
	int tmp;
//	String line;
